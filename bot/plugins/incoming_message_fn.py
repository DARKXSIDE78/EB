   ...
   # try:
    ...
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Bᴜʏ Bᴏᴛ Rᴇᴘᴏ', url='https://t.me/Darkxside78')
        ],
        [
            InlineKeyboardButton('Mᴀɪɴ Hᴜʙ', url='https://t.me/GenAnimeOfc'),
            InlineKeyboardButton('Rᴀɴᴅᴏᴍ', url='https://t.me/FusionAnime')
        ]
    ]
        ),
